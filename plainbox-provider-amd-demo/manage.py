...
setup(
    name='com.canonical.certification:plainbox-provider-amd-demo',
    version="1.0",
    description=N_("The com.canonical.certification:plainbox-provider-amd-demo provider"),
    gettext_domain="com_canonical_certification_plainbox-provider-amd-demo",
)